...
A merged game PR approves catalog inclusion. Promotion to `main` and the official
platform's pinned public-source commit update determine when that game is served officially.
