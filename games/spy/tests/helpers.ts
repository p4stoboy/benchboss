import { type CurrentMatchConfig, mkSeatId } from "@benchboss/core";
import { gameConfig } from "../../tests/config";
import { plugin } from "../src/plugin";

export function baseConfig(_rounds = 5): CurrentMatchConfig {
...
export function handlerConfig(rounds = 5): CurrentMatchConfig {
